...
const Header = () => {
   return (
    <div className='header-container'>
        <div className='food-app-logo-container'>
        <img className='food-app-logo' src='https://repository-images.githubusercontent.com/199302991/94dcc600-94ff-11eb-9058-6308bc7a425e'></img>
    </div>
    <div>
    ...
    <div className='login-container'>
        <img className='login-btn' src='https://cdn-icons-png.flaticon.com/512/5087/5087607.png'></img>
    </div>
    </div>
   )
}
...
const BodyComp = () =>{
    return (<div className='body-container'>
        ...
        <div className='restro-container'>
            {
                resList.map(restro=><RestroCard resObj={restro}></RestroCard>)
            }
            {/* <RestroCard resObj={resList[0]}/> */}
        </div>
    </div>)
}
...
const RestroCard = (props) =>{
    const {resObj} = props;
    const { name,avgRating,cuisines,costForTwo,sla,cloudinaryImageId} = resObj?.info;
    const url = 'https://media-assets.swiggy.com/swiggy/image/upload/fl_lossy,f_auto,q_auto,w_1024/'+cloudinaryImageId;
    return (<div className='restro-card'>
    <img className='restro-food-logo' src={url}></img>
     <div className='restroname'>{name+" "+avgRating}
     <img className='rating-star-logo' src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSn2fO06E83wILT6e9SNlK8MUEtKGAAmj8kzQ&usqp=CAU"></img>
     </div>
     <div className='cuisines'>{cuisines.join(", ")}</div>
     <div className='costfortwo'>{costForTwo}</div>
     <div className='deliveryTime'>
      <img className='deliveryLogo' src='https://cdn5.vectorstock.com/i/1000x1000/48/19/moto-food-delivery-icon-outline-style-vector-26804819.jpg'></img>  
      {sla.deliveryTime} Minutes</div>
</div>)
}
...
const resList = [
    {
      "info": {
        ...
        "availability": {
          "nextCloseTime": "2023-10-30 06:00:00",
          "opened": true
        },
        "badges": {
    ...
    },
    {
      "info": {
        ...
        "availability": {
          "nextCloseTime": "2023-10-30 03:00:00",
          "opened": true
        },
        "badges": {
    ...
    },
    {
      ...
      "cta": {
        "link": "https://www.swiggy.com/restaurants/kfc-nibm-road-kondhwa-pune-313404",
        "type": "WEBLINK"
      }
    },
    {
    ...
    },
    {
      "info": {
        ...
        "availability": {
          "nextCloseTime": "2023-10-30 04:00:00",
          "opened": true
        },
        "badges": {
          "imageBadges": [
    ...
    },
    {
      "info": {
        ...
        "availability": {
          "nextCloseTime": "2023-10-30 05:00:00",
          "opened": true
        },
        "badges": {
      ...
      "cta": {
        "link": "https://www.swiggy.com/restaurants/cheesiano-pizza-aundh-balewadi-pune-7127",
        "type": "WEBLINK"
      }
    },
    {
    ...
    },
    {
      "info": {
        ...
        "cloudinaryImageId": "sholmkvmvnzb10gldd8p",
        "locality": "Sacred World Mall",
        "areaName": "Wanowrie",
      ...
      "cta": {
        "link": "https://www.swiggy.com/restaurants/mcdonalds-gourmet-burger-collection-sacred-world-mall-wanowrie-pune-395201",
        "type": "WEBLINK"
      }
    },
    {
...
//     React.createElement('h2',{},'this is head2'),
//     React.createElement('h3',{},'this is head3')
// ]);

// const header = (<div className='title'><h1>
//     this is head1</h1>
//     <h2>this is head2</h2>
//     <h3>this is head3</h3>
//     </div>);  
...
// const TitleComp = () => {
//     return (<div>this is title component</div>)
// }
